...
# Add bounding boxes in this format, these are just example coordinate
    ...
    for (scale,ystart,ystop) in scales:
        ...
        for xb in range(nxsteps):
            for yb in range(nysteps):
                ...
                feature_vec = np.hstack((spatial_features, hist_features, hog_features)).reshape(1, -1)
                test_features = X_scaler.transform(feature_vec)
                ...
                if test_prediction == 1:
                    hot_boxes.append(((xbox_left, ytop_draw+ystart),(xbox_left+win_draw,ytop_draw+win_draw+ystart)))
